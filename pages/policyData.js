...
=              <WalletButton/>
            ...
            <div className="policy-grid">
              ...
              <button className = 'page-button' onClick = {() => {setIndex(index - itemsPerPage)}}>Previous</button>
              <button className = 'page-button' onClick = {() => {setIndex(index + itemsPerPage)}}>Next</button>
              </nav>
